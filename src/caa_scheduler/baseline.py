...
def build_baseline(config_path: Path, repo_root: Path) -> dict[str, Any]:
    ...
    exact_materialization_plan = build_exact_materialization_plan_from_manifest(
        canonical,
        frequency_fleet_plan,
        hub_bank_plan,
        routing_repair_plan,
    ...
    write_json(
        output_directory / "routing_repair_plan.json",
        routing_repair_plan,
        indent=None,
    )
    write_json(
    ...
    write_json(
        output_directory / "exact_materialization_plan.json",
    ...
    return {
        ...
        "exactMaterializationPlan": exact_materialization_plan,
