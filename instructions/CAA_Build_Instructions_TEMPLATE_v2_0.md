...
36. A capacity-validated hub-bank assignment is a binding construction decision. Exact materialization must carry each leg's assigned bank ID forward as a hard timing-domain restriction, rather than reopening that leg to any bank at the same hub; otherwise the downstream optimizer can invalidate the upstream capacity proof and create a large, unnecessary symmetry/runtime penalty. (Schedule 7 v0.1.0)
